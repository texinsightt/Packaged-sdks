...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/texinsightt/Packaged-sdks/releases/download/0.1.0/NewkyCardScanner.xcframework.zip",
            checksum: "40f72cbd0eed7e7451ffec074f6de3fa1b52253c84a0ac28c4148ca94701c7d9"
        ),
        .binaryTarget(
            name: "NewkyFace",
            url: "https://github.com/texinsightt/Packaged-sdks/releases/download/0.1.0/NewkyFace.xcframework.zip",
